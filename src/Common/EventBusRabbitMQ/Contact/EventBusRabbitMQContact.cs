...
{
    public class EventBusRabbitMQContact
    {
        private readonly IRabbitMQPersistentConnection _persistentConnection;
        private readonly ILogger<EventBusRabbitMQContact> _logger;
        private readonly int _retryCount;

        public EventBusRabbitMQContact(IRabbitMQPersistentConnection persistentConnection,
            ILogger<EventBusRabbitMQContact> logger, int retryCount = 5)
        {
